...
namespace Nadis.Net
{
    public class PlayerSync : MonoBehaviour
    {
        ...
        private void SubscribeEvents()
        {
            ...
            Events.Player.SetMoveData += SetProceduralMoveData;
        }
        ...
        private void Start()
        {
            if(idSet == false)
            {
                GetComponent<BipedProceduralAnimator>().InitialSetup(ID);
            }
        }
        ...
        private void SetPosition(int playerID, Vector3 newPosition)
        {
        ...
        private void SetRotation(int playerID, float newRotation)
        {
            if (playerID != ID) return;
        ...
        private void SetProceduralMoveData(int playerID, bool grounded, Vector2 inputDir, PlayerMoveState moveState, float moveSpeed)
        {
        ...
        private void Disconnected(int playerID)
        {
            if (playerID != ID) return;
